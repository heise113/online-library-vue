...
export default {
    ...
    getAboutBook(name_id) {
        return {
            ...
            name_id: 'witcher-poslednee-zhelanie',
            name: 'Последнее желание.',
            genres: ['Боевое фентези', 'Художественная литература', 'Фентези', 'Эпическое фентези'],
    ...
    getPopularGenres() {
        return ["детективы", "фентези", "ужасы", "приключения", "поэзия", "фантастика", "любовные романы", "триллеры", "комиксы и манга", "проза"]
    }
}